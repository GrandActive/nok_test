...
abstract class $SpecializationCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, List<Qualification> qualifications});
}
...
class _$SpecializationImpl implements _Specialization {
  const _$SpecializationImpl(
      {required this.id,
      required this.name,
      required final List<Qualification> qualifications})
  ...
  @override
  String toString() {
    return 'Specialization(id: $id, name: $name, qualifications: $qualifications)';
  }
