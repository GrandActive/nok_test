...
class _PaymentsApi implements PaymentsApi {
  _PaymentsApi(
    ...
    baseUrl ??= 'http://nok-trainer.ru/api/payment/';
  }
  ...
  Future<PaymentData> getPaymentData(Map<String, dynamic> userTokenJson) async {
    ...
    late PaymentData _value;
    try {
      _value = PaymentData.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<OrderStatusApiResponse> getPaymentStatus(String userToken) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OrderStatusApiResponse _value;
    try {
      _value = OrderStatusApiResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
